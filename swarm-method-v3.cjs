...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        alignment: AlignmentType.CENTER,
        children: [new TextRun({ text: "Version 3.0", size: 22, font: "Arial", color: COLORS.gray })]
      }),
            ...
            children: [
              new TableCell({
                ...
                children: [
                  ...
                  new Paragraph({
                    children: [
                      new TextRun({ text: "Real problems over assumed problems", bold: true, size: 28, color: COLORS.primary }),
                    ]
                  }),
                ]
              })
      ...
      new Paragraph({
        ...
        children: [
          ...
          new TextRun({ text: "maximizing quality attempts on real problems", bold: true, size: 24 }),
                ...
                children: [
                  ...
                  new Paragraph({
                    children: [
                      ...
                      new TextRun({ text: "\"How do I maximize quality attempts on the right problem?\"", italics: true, bold: true, size: 22 })
                    ]
                  })
                ]
              })
      ...
      new Paragraph({
        spacing: { after: 200 },
        children: [new TextRun({ text: "Everyone on the team does product work. Everyone connects problems to strategy. Everyone decides what swarms to create and why.", size: 24 })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("The Nine Tenets")]
      }),
      new Paragraph({
        spacing: { after: 200 },
      ...
      new Paragraph({
        ...
        children: [new TextRun("1. Discover Before You Deliver")]
      }),
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
            ...
            children: [
              new TableCell({
                ...
                children: [
                  ...
                  new Paragraph({ children: [new TextRun({ text: "Assume you know the problem, build the solution", size: 20 })] })
                ]
              }),
              new TableCell({
                shading: { fill: COLORS.light, type: ShadingType.CLEAR },
                ...
                children: [
                  ...
                  new Paragraph({ children: [new TextRun({ text: "Validate the problem is real, then swarm on solutions", size: 20 })] })
                ]
              })
            ]
          })
      ...
      new Paragraph({
        ...
        children: [new TextRun({ text: "\"The fastest swarm in the wrong direction is still lost. I invest in discovery before I invest in delivery.\"", italics: true, size: 22 })]
      }),

      // Tenet 2
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("2. Intent Over Instruction")]
      }),
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
        columnWidths: [4200, 4200],
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("3. Parallel by Default")]
      }),
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
        columnWidths: [4200, 4200],
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("4. Context is Currency")]
      }),
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
        columnWidths: [4200, 4200],
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("5. Small Bets, Fast Funerals")]
      }),
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
        columnWidths: [4200, 4200],
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("6. Humans Hold the Why")]
      }),
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
        columnWidths: [4200, 4200],
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("7. Mastery Through Direction")]
      }),
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
        columnWidths: [4200, 4200],
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("8. Ship the Learning")]
      }),
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
        columnWidths: [4200, 4200],
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("9. Humans Rest, Agents Run")]
      }),
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
        columnWidths: [4200, 4200],
            ...
            children: [
              new TableCell({
                ...
                children: [
                  ...
                  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 50 }, children: [new TextRun({ text: "Define problem, launch experiments", color: COLORS.white, size: 18 })] })
                ]
              }),
              new TableCell({
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("1. SPAWN: Validate Problem, Launch Experiments")]
      }),
      new Paragraph({
        spacing: { after: 150 },
        children: [new TextRun({ text: "Before spawning solutions, confirm the problem is real and worth solving. Then launch 3-5 parallel experiments.", size: 24 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Identify the customer problem and evidence it's real", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Connect the problem to strategy—why this, why now?", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Define success criteria and kill criteria BEFORE launching", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Spawn both discovery experiments (is this the right solution?) and delivery experiments (can we build it?)", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        spacing: { after: 200 },
      ...
      // Two types of experiments callout
      new Table({
        width: { size: 100, type: WidthType.PERCENTAGE },
        columnWidths: [9360],
        rows: [
          new TableRow({
            children: [
              new TableCell({
                ...
                children: [
                  new Paragraph({
                    children: [new TextRun({ text: "TWO TYPES OF EXPERIMENTS", bold: true, size: 22, color: COLORS.primary })]
                  }),
                  new Paragraph({
                    spacing: { before: 100 },
                    children: [
                      new TextRun({ text: "Discovery experiments ", bold: true, size: 20 }),
                      new TextRun({ text: "test assumptions about the problem and solution fit:", size: 20 })
                    ]
                  }),
                  new Paragraph({
                    numbering: { reference: "bullets", level: 0 },
                    children: [new TextRun({ text: "Do people have this problem? Would they use this solution? Can they figure it out?", size: 20 })]
                  }),
                  new Paragraph({
                    spacing: { before: 100 },
                    children: [
                      new TextRun({ text: "Delivery experiments ", bold: true, size: 20 }),
                      new TextRun({ text: "test assumptions about feasibility:", size: 20 })
                    ]
                  }),
                  new Paragraph({
                    numbering: { reference: "bullets", level: 0 },
                    children: [new TextRun({ text: "Can we build it? Will it scale? Does it perform?", size: 20 })]
                  }),
                  new Paragraph({
                    spacing: { before: 100 },
                    children: [new TextRun({ text: "Discovery failures kill faster than delivery failures—run them first or in parallel.", italics: true, size: 20 })]
                  })
                ]
              })
            ]
            ...
            children: [
              new TableCell({
                ...
                children: [
                  ...
                  new Paragraph({
                    numbering: { reference: "bullets", level: 0 },
                    children: [new TextRun({ text: "Does it solve a real customer problem, or just produce output?", size: 20 })]
                  }),
                  new Paragraph({
                    numbering: { reference: "bullets", level: 0 },
                    children: [new TextRun({ text: "Would someone with domain expertise approve this quality?", size: 20 })]
                  }),
                  new Paragraph({
                    numbering: { reference: "bullets", level: 0 },
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Vision and strategy connection—where this work fits", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Customer problems we're solving and evidence they're real", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "What surprised us—especially customer discoveries", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("4. The Problem Stack")]
      }),
      new Paragraph({
        spacing: { after: 100 },
        children: [
          new TextRun({ text: "Purpose: ", bold: true, size: 22 }),
          new TextRun({ text: "A prioritized list of customer problems worth swarming on, with evidence.", size: 22 })
        ]
      }),
      new Paragraph({
        spacing: { after: 50 },
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Customer problem (specific, observable)", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Evidence it's real (data, quotes, observations)", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Who has this problem (specific segment)", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Why now—connection to strategy", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Risks to validate before building", size: 22 })]
      }),
      new Paragraph({
        spacing: { before: 100, after: 250 },
        shading: { fill: COLORS.light, type: ShadingType.CLEAR },
        indent: { left: 400, right: 400 },
        children: [new TextRun({ text: "Rule: No swarm starts without a problem from the stack. If you can't articulate the problem, you can't solve it.", italics: true, size: 22 })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("The Six Ceremonies")]
      }),
      new Paragraph({
        spacing: { after: 150 },
      ...
      // Ceremony 2 - Customer Heartbeat (NEW)
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("2. The Customer Heartbeat (Weekly, varies)")]
      }),
      new Paragraph({
        spacing: { after: 100 },
        children: [
          new TextRun({ text: "Purpose: ", bold: true, size: 22 }),
          new TextRun({ text: "Maintain direct contact with customers so swarms solve real problems.", size: 22 })
        ]
      }),
      new Paragraph({
        spacing: { after: 50 },
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Every team member has direct customer exposure weekly", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Watch user sessions, read support tickets, join customer calls", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Surface discoveries in the Velocity Log", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Update the Problem Stack with new evidence", size: 22 })]
      }),
      new Paragraph({
        spacing: { before: 100, after: 250 },
        shading: { fill: COLORS.light, type: ShadingType.CLEAR },
        indent: { left: 400, right: 400 },
        children: [new TextRun({ text: "Rule: Agents can summarize customer feedback. They cannot replace direct customer contact. If no one talked to a customer this week, your Problem Stack is guesses.", italics: true, size: 22 })]
      }),

      // Ceremony 3
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("3. The Convergence (Weekly, 45 min)")]
      }),
      new Paragraph({
        spacing: { after: 100 },
        children: [
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Share customer discoveries from the Heartbeat", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Re-prioritize Problem Stack based on new evidence", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("4. The Funeral (As needed, 15 min)")]
      }),
      new Paragraph({
        spacing: { after: 100 },
        children: [
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("5. The Handoff (At transitions)")]
      }),
      new Paragraph({
        spacing: { after: 100 },
        children: [
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("6. The Calibration (Quarterly, half day)")]
      }),
      new Paragraph({
        spacing: { after: 100 },
        children: [
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun({ text: "Are we staying connected to real customer problems?", size: 22 })]
      }),
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
            ...
            children: [
              new TableCell({
                ...
                children: [
                  ...
                  new Paragraph({
                    alignment: AlignmentType.CENTER,
                    children: [new TextRun({ text: "Real problems over assumed problems", size: 22, color: COLORS.white })]
                  })
                ]
              })
            ]
          ...
          new TableRow({
            children: [
              new TableCell({
                ...
                children: [
                  new Paragraph({ numbering: { reference: "principles", level: 0 }, children: [new TextRun({ text: "Discover Before You Deliver", size: 20 })] }),
            ...
            children: [
              new TableCell({
                ...
                children: [
                  ...
                  new Paragraph({ numbering: { reference: "principles", level: 0 }, children: [new TextRun({ text: "Problem Stack", size: 20 })] }),
              ...
              new TableCell({
                ...
                width: { size: 4680, type: WidthType.DXA },
                children: [
                  new Paragraph({ children: [new TextRun({ text: "The Six Ceremonies", bold: true, size: 24, color: COLORS.secondary })] }),
                  ...
                  new Paragraph({ numbering: { reference: "principles", level: 0 }, children: [new TextRun({ text: "Customer Heartbeat (weekly)", size: 20 })] }),
            ...
            children: [
              new TableCell({
                ...
                children: [
                  new Paragraph({
                    alignment: AlignmentType.CENTER,
                    children: [new TextRun({ text: "Everyone does product work.", size: 24, color: COLORS.dark })]
                  }),
                  new Paragraph({
                    alignment: AlignmentType.CENTER,
                    children: [new TextRun({ text: "Everyone connects problems to strategy.", size: 24, color: COLORS.dark })]
                  }),
                  new Paragraph({
                    alignment: AlignmentType.CENTER,
                    children: [new TextRun({ text: "Everyone decides what swarms to create.", size: 24, bold: true, color: COLORS.primary })]
                  }),
                  new Paragraph({
                    alignment: AlignmentType.CENTER,
                    spacing: { before: 150 },
                    children: [new TextRun({ text: "The teams that maximize quality attempts on real problems will build what used to take years in months.", size: 22, italics: true, color: COLORS.gray })]
                  }),
                  new Paragraph({
                    alignment: AlignmentType.CENTER,
                    spacing: { before: 100 },
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("/sessions/eager-amazing-newton/mnt/Antigravity/The-Swarm-Method-v3.docx", buffer);
  console.log("Document created: The-Swarm-Method-v3.docx");
});
